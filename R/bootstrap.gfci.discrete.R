bootstrap.gfci.discrete <- function(df, structurePrior = 1.0, samplePrior = 1.0, maxDegree = 3, maxPathLength = -1,
    ...
    fges <- list()
    class(fges) <- "bootstrap.gfci.discrete"
    ...
    # Initiate Bootstrapping GFCI Discrete
