bootstrap.rfci.mixed <- function(df, numCategoriesToDiscretize = 4, depth = 3, maxPathLength = -1,
    ...
    fges <- list()
    class(fges) <- "bootstrap.rfci.mixed"
    ...
    .jcall(parameters_instance, "V", "set", "depth", parameter_instance)
    ...
    # Initiate Bootstrapping RFCI Mixed Data
